  ...
  <div x-data="clientesProspectados()" x-init="init()" class="p-4 w-full max-w-md mx-auto space-y-6">
        ...
        <div class="px-3 py-2 space-y-4">
          <div class="bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div>
              ...
              @empty
                <p class="px-3 py-4 text-sm text-gray-500 text-center">Sin clientes nuevos en Prospectados</p>
              @endforelse
            </div>
          </div>
    ...
    @empty
      <div class="rounded-2xl bg-white border border-dashed border-gray-300 p-6 text-center text-sm text-gray-500 shadow-sm">
        No hay clientes en Prospectados registrados para tus promotores.
      </div>
    @endforelse
