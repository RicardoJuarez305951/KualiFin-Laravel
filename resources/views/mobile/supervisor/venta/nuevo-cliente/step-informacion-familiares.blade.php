    ...
    <div class="space-y-3 rounded-lg border border-gray-200 p-3">
      ...
      <div class="flex items-center gap-2">
        ...
        <input type="checkbox"
               ...
               x-model="form.familiares.tiene_conyuge"

               @change="handleConyugeToggle()">

        <span class="text-sm font-semibold text-gray-700">Registrar informacion del Conyuge</span>

      </div>

      <template x-if="form.familiares.tiene_conyuge">
      ...
      <p class="text-[11px] text-gray-500" x-show="!form.familiares.tiene_conyuge">Marca la casilla si deseas capturar la informacion del conyuge.</p>
