<x-layouts.authenticated title="Ventas y desembolsos">
    @php
        $weeklyMetrics = [
        ...
        $dailyTimeline = [
            [
                'time' => '08:45',
                'title' => 'Desembolso CR-5489',
                'description' => 'Cliente: Laura Campos - $45,000 - Promotor: Ana Beltran',
                'status' => 'Liberado',
            ],
            [
                'time' => '10:12',
                'title' => 'Validacion CR-5531',
                'description' => 'Cliente: Rogelio Nunez - $38,000 - En revision de documentacion',
                'status' => 'En curso',
            ],
            [
                'time' => '11:40',
                'title' => 'Cancelacion CR-5495',
                'description' => 'Cliente: Diego Paez - Motivo: Documentacion incompleta',
                'status' => 'Cancelado',
            ],
            [
                'time' => '13:05',
                'title' => 'Desembolso CR-5542',
                'description' => 'Cliente: Miriam Soto - $52,000 - Promotor: Marcos Rivera',
                'status' => 'Liberado',
            ],
        ];
